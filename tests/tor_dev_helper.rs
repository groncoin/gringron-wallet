...
#[ignore]
#[test]
fn socks_tor() -> Result<(), gringron_wallet_controller::Error> {
	...
	// bound to the listening port 55635. By default, tor will also be running
	// a socks proxy lister at 127.0.0.1 9050 (both wallets can use for now)
	//
	// Relevant torrc config:
	// HiddenServiceDir ./hidden_service/
	// HiddenServicePort 80 127.0.0.1:55635
	//
	// tor -f torrc
	...
	let arg_vec = vec!["gringron-wallet", "-p", "password", "listen"];
