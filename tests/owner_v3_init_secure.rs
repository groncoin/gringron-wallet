...
use gringron_util::secp::key::SecretKey;
...
#[test]
fn owner_v3_init_secure() -> Result<(), gringron_wallet_controller::Error> {
	...
	let arg_vec = vec!["gringron-wallet", "-p", "password", "owner_api", "-l", "33420"];
	thread::spawn(move || {
