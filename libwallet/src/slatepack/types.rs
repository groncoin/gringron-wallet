...
use crate::dalek_ser;
use crate::gringron_core::ser::{self, Readable, Reader, Writeable, Writer};
use crate::Error;
use gringron_wallet_util::byte_ser;
...
#[test]
fn slatepack_bin_basic_ser() -> Result<(), gringron_wallet_util::byte_ser::Error> {
	use gringron_wallet_util::byte_ser;
...
#[test]
fn slatepack_bin_opt_fields_ser() -> Result<(), gringron_wallet_util::byte_ser::Error> {
...
#[test]
fn slatepack_bin_future() -> Result<(), gringron_wallet_util::byte_ser::Error> {
	use crate::gringron_core::global;
	use byteorder::{BigEndian, ReadBytesExt, WriteBytesExt};
	use gringron_wallet_util::byte_ser;
