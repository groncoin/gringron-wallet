...
use crate::gringron_core::core::hash::Hash;
use crate::gringron_core::core::FeeFields;
use crate::gringron_core::core::{Output, Transaction, TxKernel};
use crate::gringron_core::libtx::{aggsig, secp_ser};
use crate::gringron_core::{global, ser};
use crate::gringron_keychain::{Identifier, Keychain};
use crate::gringron_util::logger::LoggingConfig;
use crate::gringron_util::secp::key::{PublicKey, SecretKey};
use crate::gringron_util::secp::{self, pedersen, Secp256k1};
use crate::gringron_util::{ToHex, ZeroingString};
	...
	K: Keychain + 'a,
{
	...
	/// default is assumed to be ~/.gringron/main/wallet_data (or testnet equivalent)
	...
	/// Output a gringron-wallet.toml file into the current top-level system wallet directory
	fn create_config(
		&self,
...
pub trait NodeClient: Send + Sync + Clone {
	...
	/// Posts a transaction to a gringron node
	...
	/// retrieves the current tip (height, hash) from the specified gringron node
	...
	/// retrieve a list of outputs from the specified gringron node
