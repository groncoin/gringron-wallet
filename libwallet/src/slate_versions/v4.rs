...
//! Contains V4 of the slate (gringron-wallet 4.0.0)
//! Changes from V3:
...
use crate::gringron_core::core::{Input, Output, TxKernel};
use crate::gringron_core::libtx::secp_ser;
use crate::gringron_keychain::{BlindingFactor, Identifier};
use crate::gringron_util::secp;
...
pub struct VersionCompatInfoV4 {
	...
	pub version: u16,
	/// Version of gringron block header this slate is compatible with
