...
pub struct WalletConfig {
	...
	/// Location of the node api secret for basic auth on the GrinGron API
	...
	/// should match accept_fee_base parameter in gringron-server
...
impl Default for WalletConfig {
	fn default() -> WalletConfig {
		WalletConfig {
			...
			check_node_api_http_addr: "http://127.0.0.1:5633".to_string(),
...
impl Default for TorConfig {
	fn default() -> TorConfig {
		TorConfig {
			...
			socks_proxy_addr: "127.0.0.1:61260".to_owned(),
