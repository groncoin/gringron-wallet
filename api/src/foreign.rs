	...
	K: Keychain + 'a,
{
	...
	/// None
	/// # Returns
	/// * [`VersionInfo`](../gringron_wallet_libwallet/api_impl/types/struct.VersionInfo.html)
	/// # Example
	/// Set up as in [`new`](struct.Foreign.html#method.new) method above.
	/// ```
	/// # gringron_wallet_api::doctest_helper_setup_doc_env_foreign!(wallet, wallet_config);
	///
	...
	/// is set to `Unsent` and a [Transaction Log Entry](../gringron_wallet_libwallet/types/struct.TxLogEntry.html)
	/// will be created. Note the output will be unspendable until the coinbase maturity period
	/// has expired.
	///
	/// # Arguments
	///
	/// * `block_fees` - A [`BlockFees`](../gringron_wallet_libwallet/api_impl/types/struct.BlockFees.html)
	...
	///
	/// # Returns
	/// * `Ok`([`cb_data`](../gringron_wallet_libwallet/api_impl/types/struct.CbData.html)`)` if successful. This
	...
	/// [`Slate`](../gringron_wallet_libwallet/slate/struct.Slate.html) object, modified with
	...
	///
	/// Also creates a corresponding [Transaction Log Entry](../gringron_wallet_libwallet/types/struct.TxLogEntry.html)
	/// in the wallet's transaction log.
	///
	/// # Arguments
	/// * `slate` - The transaction [`Slate`](../gringron_wallet_libwallet/slate/struct.Slate.html).
