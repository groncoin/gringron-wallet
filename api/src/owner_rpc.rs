...
pub trait OwnerRpc {
	...
	```
	# gringron_wallet_api::doctest_helper_json_rpc_owner_assert_response!(
	# r#"
	{
		"jsonrpc": "2.0",
		"method": "accounts",
	...
	*/
	...
	parameter. See  (../gringron_wallet_libwallet/types.struct.RetrieveTxQueryArgs.html)
		...
		# r#"
		{
			...
			"params": {
				...
				"args": {
					...
					"payment_proof_recipient_address": "tgringron1xtxavwfgs48ckf3gk8wwgcndmn0nt4tvkl8a7ltyejjcy2mc6nfs9gm2lp",
					"ttl_blocks": null,
					"send_args": null
				}
			},
	...
	# r#"
	{
		...
		"params": {
			...
			"wallet_config": {
				...
				"api_listen_port": 5635,
				"owner_api_listen_port": 3420,
				"api_secret_path": null,
				"node_api_secret_path": null,
				"check_node_api_http_addr": "http://127.0.0.1:5633",
	...
	*/
	...
	# r#"
	{
		...
		"jsonrpc": "2.0",
		"result": {
			"Ok": "tgringron1xtxavwfgs48ckf3gk8wwgcndmn0nt4tvkl8a7ltyejjcy2mc6nfs9gm2lp"
		}
	}
	# "#
	# , 0, false, false, false, false);
	...
	# r#"
	{
		...
		"result": {
			"Ok": {
				...
				"sender": "tgringron1xtxavwfgs48ckf3gk8wwgcndmn0nt4tvkl8a7ltyejjcy2mc6nfs9gm2lp",
				"slatepack": "1.0"
			}
		}
	}
	...
	# r#"
	{
		...
		"result": {
			"Ok": {
				...
				"recipient_address": "tgringron10qlk22rxjap2ny8qltc2tl996kenxr3hhwuu6hrzs6tdq08yaqgqq6t83r",
				...
				"sender_address": "tgringron1xtxavwfgs48ckf3gk8wwgcndmn0nt4tvkl8a7ltyejjcy2mc6nfs9gm2lp",
	...
	*/
	...
	# r#"
	{
		...
		"params": {
			"tor_config": {
				"use_tor_listener": true,
				"socks_proxy_addr": "127.0.0.1:61260",
				"send_config_dir": "."
			}
		},
		"id": 1
...
pub fn run_doctest_owner(
	...
	use gringron_wallet_libwallet::{api_impl, WalletInst};
...
macro_rules! doctest_helper_json_rpc_owner_assert_response {
	($request:expr, $expected_response:expr, $blocks_to_mine:expr, $perform_tx:expr, $lock_tx:expr, $finalize_tx:expr, $payment_proof:expr) => {
		...
		{
			use gringron_wallet_api::run_doctest_owner;
			use serde_json;
