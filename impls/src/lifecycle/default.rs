...
use crate::config::{
	config, GlobalWalletConfig, GlobalWalletConfigMembers, TorConfig, WalletConfig, GRINGRON_WALLET_DIR,
};
...
use gringron_util::logger::LoggingConfig;
use std::fs;
	...
	K: Keychain + 'a,
{
	...
	fn create_config(
		...
		data_dir_name.push(GRINGRON_WALLET_DIR);
